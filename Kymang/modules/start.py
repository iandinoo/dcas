...
ɪɴɪ ᴀᴅᴀʟᴀʜ  {}​ ʏᴀɴɢ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ ᴋᴀʟɪᴀɴ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴜᴀᴛ ʙᴏᴛ ғɪʟᴇ sʜᴀʀɪɴɢ ᴛᴀɴᴘᴀ ʜᴀʀᴜs ᴍᴇᴍɪʟɪᴋɪ ᴠᴘs/ʜᴇʀᴏᴋᴜ sᴇɴᴅɪʀɪ
...
<b>**
 • ᴄʀᴇᴀᴛᴏʀ : {}
 • ᴅᴇᴠᴇʟᴏᴠᴇᴅ : </b><a href="https://t.me/OWNERDCAS/">ꭙ͢ᴅᴄᴀs</a>
 • sᴜᴘᴘᴏʀᴛ : </b><a href="https://t.me/DCASOFCBOT/">ᴅᴄᴀsᴏғᴄ</a>**
"""


mbuttons = [
        [
            InlineKeyboardButton("ᴛᴇɴᴛᴀɴɢ sᴀʏᴀ", callback_data="cb_about"),
...
buttons2 = [
    [
        InlineKeyboardButton("ᴅᴇᴘʟᴏʏ ʙᴏᴛ 🤖", callback_data="buat_bot"),
    ],
    [
        InlineKeyboardButton("ᴛᴜᴛᴏʀɪᴀʟ", callback_data="cb_tutor"),
        InlineKeyboardButton("ᴀᴅᴍɪɴ 👑", callback_data="cb_admines"),
    ],
    [
